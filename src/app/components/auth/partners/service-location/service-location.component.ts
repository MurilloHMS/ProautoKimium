...
export class ServiceLocationComponent {
    ...
    constructor(private serviceLocationService: ServiceLocationsService, private fb: FormBuilder){
    ...
    save(){
        if(this.form.valid){
            const slData: serviceLocation = this.form.value;

            if(this.sl2Edit){
                this.serviceLocationService.updateServiceLocation(slData).subscribe({
                    next: () => {
                        this.visible = false;
                ...
                this.serviceLocationService.addServiceLocation(slData).subscribe({
                    next: () => {
                        this.visible = false;
                        this.loadServiceLocations();
                    },
