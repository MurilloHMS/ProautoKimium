...
export class FaqComponent {
  ...
  { title: 'Quais as formas de pagamento?', body: 'Aceitamos pagamentos via boleto, PIX, transferência e faturamento conforme aprovação de crédito. Em alguns casos, também cartões de crédito sob consulta.', value: '5' },
  ...
  { title: 'Qual o horário de atendimento?', body: 'Nosso atendimento funciona de segunda a sexta-feira, das 07:30h às 17:30h, por telefone, e-mail ou WhatsApp. Atendimentos técnicos e visitas comerciais também podem ser agendados.', value: '8' },
