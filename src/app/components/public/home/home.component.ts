...
@Component({
    selector: 'app-home',
  imports: [HeroComponent, ProcessoConsultoriaComponent, MotivosContratarComponent, ServicosOfertadosComponent, AboutUsComponent, ContactComponent, FraudAlertComponent, RevealDirective],
